...
function eventKrpanoLoaded () {
	...
	ktools.I18N.getInstance().initLanguage('en', crossDomainTargetUrl+'multi_religious_compounddata/multi_religious_compound_messages_en.xml');
	krpanoLoaded = true;
	
	
	

addKolorMap('panotourmaps', [['openlayers','AIzaSyDblU_CgcysoizfMJiAWojM0MPPVd9fBFc']]);
...
function addKolorMenu(pPlugID) 
{
	...
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMenu/KolorMenu.min.js", [], true);
	...
	if(mapsApiLength > 0){
		...
		if (mapsApiLength > 1) {
			...
			if (mapsApiLength > 2) {
				...
				var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript3], false);
				var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScript], false);
				var mapstractionScriptCoreLayer3 = new ktools.Script("maps_mapstraction_core_layer3", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/"+mapApiOrder[2][3]+refreshIE, [mapstractionScriptCore], false);
				var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCoreLayer3], false);
				var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
			} else {
				var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript2], false);
				var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScript], false);
				var mapstractionScriptCoreLayer2 = new ktools.Script("maps_mapstraction_core_layer2", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/"+mapApiOrder[1][3]+refreshIE, [mapstractionScriptCore], false);
				var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCoreLayer2], false);
			}
		} else {
			var mapstractionScript = new ktools.Script("maps_mapstraction", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/mxn.js"+refreshIE, [mapApiScript], false);
			var mapstractionScriptCore = new ktools.Script("maps_mapstraction_core", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/mxn.core.js"+refreshIE, [mapstractionScript], false);
			var mapstractionScriptCoreLayer1 = new ktools.Script("maps_mapstraction_core_layer1", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/lib/"+mapApiOrder[0][3]+refreshIE, [mapstractionScriptCore], false);
		}
		
		var kolorMapScript = new ktools.Script("kolormap", crossDomainTargetUrl+"multi_religious_compounddata/graphics/KolorMap/js/KolorMap.min.js", [mapstractionScriptCoreLayer1], true);
...
function initKolorMapOnReady(pluginName, defaultMapLayer, mapAreaDiv) {
	...
	kolorMap.setGraphicsUrl(crossDomainTargetUrl+"multi_religious_compounddata/graphics/"+pluginName.toLowerCase()+"/");
