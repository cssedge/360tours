...
g;break;default:i=b-g}d.t()&&(a+='<li class="kolorMenuItem" style="z-index:'+i+';">',a+='<p id="'+d.getName()+'" class="'+d.s()+'">',c.text_align_left&&(a+="<span>"+d.e()+"</span>"),""!=d.o()&&(a+='<img src="../../../Relegions Centerdata/graphics/KolorMenu/'+d.o()+'" alt="'+d.e()+'" />'),c.text_align_left===n&&(a+="<span>"+d.e()+"</span>"),a+="</p>",a+='<ul class="kolorMenuGroup">');for(var l=0;l<h;l++)f=d.d().get(l),a+='<li class="kolorMenuItem" style="z-index:'+i+';">',a+='<p id="'+f.getName()+'" class="'+f.s()+'">',c.text_align_left&&""!=f.e()&&
(a+="<span>"+f.e()+"</span>"),""!=f.o()&&(a+='<img src="../../../Relegions Centerdata/graphics/KolorMenu/'+f.o()+'" alt="'+f.e()+'" />'),c.text_align_left===n&&""!=f.e()&&(a+="<span>"+f.e()+"</span>"),a+="</p>",a+="</li>";d.t()&&(a+="</ul></li>")}jQuery("#"+o).prepend(a+"</ul></div>")}var c={position:KolorMenu.a.p,orientation:KolorMenu.c.l,sub_orientation:KolorMenu.c.m,margin_x:8,margin_y:8,background_color:"b3b3b3",background_alpha:0.4,border_color:"ffffff",border_width:0,border_style:KolorMenu.u.NONE,border_radius:7,use_out_effect:k,item_out_bg_color:"4d4d4d",
